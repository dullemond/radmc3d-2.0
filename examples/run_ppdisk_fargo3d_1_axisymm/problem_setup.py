...
# into RADMC-3D, and then azimuthally averaging the model.
#
import numpy as np
...
#
# NOW DO THE AZIMUTHAL AVERAGING
#
# Note: Set azav=False to keep full 3-D structure
#
azav  = True                  # Switch on the azimuthal averaging

if azav:
    rho_dust_3d_av = []
    for rho in rho_dust_3d:
        rhoav = rho.mean(axis=2)
        rho_dust_3d_av.append(rhoav)
    rho_dust_3d = rho_dust_3d_av
    phii = [phii[0],phii[-1]]
    nphi = 1

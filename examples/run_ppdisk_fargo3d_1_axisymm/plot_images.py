...
#
makeImage(npix=200,incl=60.,phi=30.,wav=1.3e3,setthreads=setthreads)   # This calls radmc3d 
im_mm = readImage()
plt.figure()
...
#
makeImage(npix=200,incl=60.,phi=30.,wav=1.,setthreads=setthreads)   # This calls radmc3d 
im_1 = readImage()
plt.figure()

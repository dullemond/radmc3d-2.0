...
#
makeImage(npix=200,incl=incl,phi=phi,wav=1.3e3,sizeau=200)   # This calls radmc3d 
im_mm = readImage()
plt.figure()
...
#
makeImage(npix=200,incl=incl,phi=phi,wav=1.,sizeau=200)   # This calls radmc3d 
im_1 = readImage()
plt.figure()
plotImage(im_1,au=True,log=True,vmax=-10,vmin=-15,bunit='inu',cmap='hot')
plt.text(-90,80,'With isotropic scattering',color='white')

#makeImage(npix=200,incl=incl,phi=phi,wav=1.,sizeau=200,noscat=True)   # This calls radmc3d 
...
#
makeImage(npix=200,incl=incl,phi=phi,wav=3.,sizeau=2)   # This calls radmc3d 
im_rim = readImage()
plt.figure()

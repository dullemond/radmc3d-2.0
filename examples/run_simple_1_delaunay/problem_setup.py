...
import numpy as np
#
# Import the Delaunay grid generator tool
#
from radmc3d_tools.radmc3d_delaunay_grid import *
#
...
#
# Call the Delaunay grid generator
#
grid     = Delaunaygrid(vertices)
#
# Get the coordinates of the cell centers
#
cellpts  = grid.cell_points
rr       = np.sqrt((cellpts**2).sum(axis=1))
#

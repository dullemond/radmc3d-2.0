...
rho0     = 1e-16
#
# Ratio of silicate to total dust (mass-weighted)
#
fsil     = 0.6
fcar     = 1.0-fsil
#
...
with open('dust_density.inp','w+') as f:
    ...
    f.write('2\n')                       # Nr of dust species
    data = rhod_sil.ravel(order='F')     # Create a 1-D view, fortran-style indexing
    data.tofile(f, sep='\n', format="%13.6e")
    f.write('\n')
    data = rhod_car.ravel(order='F')     # Create a 1-D view, fortran-style indexing
    data.tofile(f, sep='\n', format="%13.6e")
    f.write('\n')
#

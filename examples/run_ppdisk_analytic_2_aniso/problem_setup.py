...
#
# COPY THE OPACITY FILE FROM run_simple_2_scatmat/
#
os.system('cp ../run_simple_2_scatmat/dustkapscatmat_silicate.inp ./')
...
#
nphi     = 1
thetai   = np.linspace(thetaup,pi-thetaup,2*ntheta+1)
ntheta   = 2*ntheta

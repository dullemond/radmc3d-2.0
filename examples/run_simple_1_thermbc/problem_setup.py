...
with open('radmc3d.inp','w+') as f:
    ...
    f.write('thermal_boundary_xl = 100.\n')  # Comment out any of these BCs as experiment
    f.write('thermal_boundary_xr = 100.\n')  # With all 6 switched on, the dust temperature
    f.write('thermal_boundary_yl = 100.\n')  # must become constant at 100 K.
    f.write('thermal_boundary_yr = 100.\n')
    f.write('thermal_boundary_zl = 100.\n')
    f.write('thermal_boundary_zr = 100.\n')

...
command   = path+'optool pyr-mg70 -a {} -s -radmc -chop {}'.format(amic,chopangle)
#command   = path+'optool -c pyrmg70.lnk 1.0 3.01 -a {} -s -radmc -chop {}'.format(amic,chopangle)
os.system(command)
...
with open('wavelength_micron.inp','w') as f:
    ...
    for w in optool.wav[0]:
        f.write('{0:13.6e}\n'.format(w))
create_dustkapscatmat_file(amic,'pyrmg70',errortol=errortol,chopangle=chopangle,renametosize=False)
